...
public final class Resources {
    ...
    static final ResourceBundle BUNDLE = ResourceBundle.getBundle("name.ulbricht.led.resources");
    ...
    static final String ICON_COLOR_WHITE = "ffffff";

    static List<Image> getIcons(String iconName, String iconColor) {
    ...
    private static String getIconResourceName(String iconName, int iconSize, String iconColor) {
